    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 border rounded-lg glass-card">
          ...
          <h3 className="font-medium mb-2 text-foreground">Submit your request</h3>
          <p className="text-muted-foreground">Fill out the form with your current section and the section you want to swap to.</p>
        </div>
        
        <div className="p-4 border rounded-lg glass-card">
          <div className="h-10 w-10 rounded-full bg-campus-purple text-white flex items-center justify-center mb-3">2</div>
          <h3 className="font-medium mb-2 text-foreground">Get matched</h3>
          <p className="text-muted-foreground">Our system will notify you when we find another student looking for a complementary swap.</p>
        </div>
        
        <div className="p-4 border rounded-lg glass-card">
          <div className="h-10 w-10 rounded-full bg-campus-purple text-white flex items-center justify-center mb-3">3</div>
          <h3 className="font-medium mb-2 text-foreground">Complete the swap</h3>
          <p className="text-muted-foreground">Connect with your match and coordinate the swap through your university's course enrollment system.</p>
        </div>
      </div>
